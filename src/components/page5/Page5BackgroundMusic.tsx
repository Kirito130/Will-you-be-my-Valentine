...
/**
 * Background music for Landing Page 5: You Belong With Me on loop.
 * When duck=true (e.g. during typewriter), volume is lowered so typewriter sound stands out.
 */
export function Page5BackgroundMusic({ duck = false }: { duck?: boolean }) {
