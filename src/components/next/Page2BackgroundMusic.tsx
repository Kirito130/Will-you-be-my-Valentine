...
/**
 * Background music for Landing Page 2: Lover.MP3 on loop.
 * Resets and plays from the start on every page load/refresh. If the browser blocks
 * autoplay, retries play on first user interaction.
 */
export function Page2BackgroundMusic() {
